...
const plans = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "See how AI sees your store",
    features: [
      "AI visibility scan across 4 engines",
      "15 AI credits / month",
      "Brand profile setup",
      "Up to 5 products",
      "Chat support",
  ...
  },
  {
    ...
    features: [
      ...
      "Blog, FAQ & guide generation",
      "Monthly performance reports",
      "Unlimited products",
      "Product optimization for AI citations",
    ],
    cta: "Start Pro Plan",
    popular: false,
  },
